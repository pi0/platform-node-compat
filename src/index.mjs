...
const links = {
  ...
  "Vercel Edge (dynamic import)":
    "https://platform-node-compat.vercel.app/?dynamic_import",
...
export default async function handler(req, getBuiltin) {
  ...
  if (req.url.includes("?ts")) {
    ...
    const code = /* js */ `// Auto generated at ${new Date().toISOString().split("T")[0]}
// Source: ${req.url.replace(/\?ts/, "")}
